...
app.get('/api/sync', async (req, res) => {
    try {
        ...
        const metadata = dataRes.data.chunk
...
app.post('/api/share', async (req, res) => {
    try {
        ...
        await axios.post(`${BASE_URL}/rooms/${encodeURIComponent(targetRoom)}/send/m.room.message?access_token=${TOKEN}`, {
            body: body,
            msgtype: "m.text"
        });
